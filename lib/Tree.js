      ...
      var loadPromise = new Promise(function (resolve, reject) {
        ...
        _this.setState(function (_ref) {
          ...
          promise.then(function () {
            ...
            var newLoadedKeys = (0, _util.arrAdd)(_this.state.loadedKeys, key);
            var newLoadingKeys = (0, _util.arrDel)(_this.state.loadingKeys, key); // onLoad should trigger before internal setState to avoid `loadData` trigger twice.
